...
function Sweater() {
  ...
  const colors = ["blue", "black", "green", "light"];

  //fetch the hoodies collection
  useEffect(() => {
    const data = [];
    dbfs.collectionGroup("Sweater").onSnapshot((snapshot) => {
    ...
    <div className="max-w-[970px] min-w-[600px] mx-auto">
     ...
     {loaderEnable===false && <div className="flex items-center justify-between pt-10">
      ...
      <div className="grid lg:grid-cols-4 grid-cols-1">
       {loaderEnable===false && <div className="lg:block hidden pt-3">
