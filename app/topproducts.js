...
function Topproducts() {
    ...
    useEffect(() => {
        ...
        const fetchData = () => {
          ...
          try{
            const d = dbfs.collection("AllProducts").limit(4).onSnapshot((snapshot) => {
    ...
    <div>
      <div className='mt-10'>
       <h1 className=' text- font-semibold text-2xl my-5 pl-5'>Top<span className='font-semibold text-2xl text-pink-400'>Selling</span></h1>
       <div>
            ...
            return (
              ...
              <div className='relative'>
                <div className='absolute object-contain flex justify-center bottom-0 h-70 md:h-70 z-10 opacity-100 transition-opacity duration-700 hover:opacity-0 w-full bg-white overflow-hidden dark:bg-gray-800'>
                    <Image className="h-96 md:h-[16rem] w-full" src={curElm.images[0]} width={200} height={250} alt='product-imges'/>
                 </div>
