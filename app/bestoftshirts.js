  ...
  useEffect(() => {
    const fetchData = () => {
      const d = dbfs
        ...
        .where("category", "array-contains", "hoodie")
    ...
    <div className=" mx-auto text-black">
      <div className="mt-10">
        <div className="flex justify-between mr-5">
          <span className="font-semibold text-2xl text-center pl-5">
            Hoodies<span className="text-pink-500">ForYou</span>
          </span>
          <Link href="/hoodies" className="font-semibold text-pink-400">
            View All{" "}
          </Link>
        </div>
        <div>
