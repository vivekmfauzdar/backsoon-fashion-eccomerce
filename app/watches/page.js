...
function Watches() {
  ...
  useEffect(() => {
    try {
      const data = [];
      dbfs.collectionGroup("watch").onSnapshot((snapshot) => {
    ...
    <div className="max-w-[970px] min-w-[600px] mx-auto">
      ...
      {loaderEnable === false && (
        <div className="flex items-center justify-between pt-10">
          <h1 className="lg:text-2xl text-3xl font-semibold pl-5 lg:pl-0">
            Watches
          </h1>
      ...
      <div className="grid lg:grid-cols-4 grid-cols-1">
        ...
        <div className="grid lg:grid-cols-3 lg:col-span-3 md:grid-cols-3 grid-cols-2 justify-items-center lg:justify-items-stretch pt-5 pb-5 gap-5">
