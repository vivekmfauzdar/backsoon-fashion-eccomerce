...
function Jacket() {
  ...
  const colors = ["Blue", "Red", "Yellow", "White", "Black", "Brown"];

  //fetch the jacket collection
  useEffect(() => {
    try {
      const data = [];
      const docRef = dbfs
        .collectionGroup("Jacket")
        .get()
        .then((sn) => {
          sn.forEach((doc) => {
            data.push(doc.data());
    ...
    <div className="max-w-[970px] min-w-[600px] mx-auto">
      ...
      {loaderEnable === false && (
        <div className="flex items-center justify-between pt-10">
          <h1 className="text-3xl font-semibold pl-5 lg:pl-0">Jacket</h1>
      ...
      <div className="grid lg:grid-cols-4 grid-cols-1">
        ...
        <div className="grid lg:grid-cols-3 grid-cols-2 lg:col-span-3 justify-items-center md:justify-items-stretch col-span-1 pt-5 pb-5 gap-3">
